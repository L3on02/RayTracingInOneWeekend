...
/**
 * @brief The sphere class represents a sphere in 3D space.
 * 
 * It implements a hitable object that can be intersected by a ray.
 * The hit function determines if a ray intersects with the sphere and records the intersection details in the hit_record.
 */
